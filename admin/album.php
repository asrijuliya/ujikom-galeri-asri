...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit<?php echo $data['album_id'] ?>" style="cursor: pointer;">Edit</button>
...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $data['album_id'] ?>" style="cursor: pointer;">Hapus</button>
